...
public class Mainline {
	...
	static StudentFactory students = new StudentFactory();
	static MajorFactory majors = new MajorFactory();
	...
	public static void main(String[] args) throws SQLException {		
		...
		retrieveByIdTest(190);
		
		updateMajor(190, 4);
		
		deleteStudentTest(160);
	...
	public static void updateMajor(int id, int major_id) {
		// retrieve the student
		student = students.getById(id);
		
		// retrieve the major
		major = majors.getByField("id", major_id);
	...
	public static void deleteStudentTest(int id) {
	...
	public static void printMajor(MajorFactory majors) {
		Set<Integer> majorsKeys = majors.keySet();
		
		for(int majorKey : majorsKeys) {
			System.out.println(majors.get(majorKey));
		}
	}
}
