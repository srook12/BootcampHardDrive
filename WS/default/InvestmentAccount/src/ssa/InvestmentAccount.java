...
public class InvestmentAccount extends Account {
	...
	public InvestmentAccount(String description) {
		super(description);
	}
	
	public InvestmentAccount(int id, String description) {
		super(id, description);
	}
	
	// Takes a stock and adds it to the user's portfolio
	public void buy(Stock stock) {
		portfolio.add(stock);
	}
	
	// Takes a stock and marks it closed by setting the sellDate
