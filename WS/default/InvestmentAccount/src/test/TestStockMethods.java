...
public class TestStockMethods extends TestCase {
	Stock stock1;
	Stock stock2;
	...
	public void testSplit() {
		...
		String status = stock1.split(0, 5);
		assertEquals(Stock.SPLIT_ERROR1 + Stock.SPLIT_TO + Stock.SPLIT_ERROR2, status);
		
		status = stock2.split(10, 0);
		assertEquals(Stock.SPLIT_ERROR1 + Stock.SPLIT_FROM + Stock.SPLIT_ERROR2, status);
