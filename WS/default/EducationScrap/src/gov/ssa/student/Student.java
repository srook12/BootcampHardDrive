...
public class Student {
	...
	public Student(String firstName, String lastName, int sat, double gpa, String majorDescription) {
	...
	public void setMajorId(Major majorId) {
		if(majorId != null && getSat() >= majorId.getReqSat()) {
	...
	public String toString() {
		...
		sb.append(String.format("%-6d   %-15s   %-15s   %4.2f   %4d   %-15s", getId(), getFirstName(), getLastName(),
				getGpa(), getSat(), majorDescription));
